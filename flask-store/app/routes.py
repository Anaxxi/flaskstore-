...
def init_app(app):
    ...
    api.add_resource(order.CreateProduct, "/order/create-product")
    api.add_resource(order.CreateCategory, "/order/create-category")
    ...
    api.add_resource(user.UpdateProfile, "/user/profile")
